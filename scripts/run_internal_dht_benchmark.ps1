...
if ([string]::IsNullOrWhiteSpace($OutputPath)) {
    $OutputPath = Join-Path $RepoRoot "tmp\dht_benchmark_internal.json"
}
$MetricsPath = Join-Path $RepoRoot "tmp\dht_benchmark_internal.metrics.jsonl"
...
try {
    ...
    $env:SUPERSEEDR_DHT_BACKEND = "internal"
    ...
    Write-Host "Running internal DHT benchmark..."
