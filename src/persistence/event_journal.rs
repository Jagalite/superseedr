...
pub(super) const EVENT_JOURNAL_FILE_NAME: &str = "event_journal.toml";
pub(super) const SHARED_EVENT_JOURNAL_FILE_NAME: &str = "shared_event_journal.toml";
...
pub use native::{
    event_journal_json, event_journal_state_file_path, load_event_journal_state,
    save_event_journal_state, save_host_event_journal_state, shared_event_journal_state_file_path,
};
#[cfg(test)]
use native::{load_event_journal_state_from_path, save_event_journal_state_to_path};
