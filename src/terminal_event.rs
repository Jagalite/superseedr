...
//! Target-selected terminal input data used by the shared TUI reducers.
//!
//! Native builds use Crossterm's real event types. Browser builds get the same data shape without
//! exposing terminal polling, reads, commands, or any other I/O.
